...
<html lang="es">
  <head>
    ...
    <title>Verifique su correo corporativo</title>
  </head>
...
<p style="margin:16px 0 0 0; color:#cbd5f5; font-size:14px; letter-spacing:1px; text-transform:uppercase;">
                  Verifique su correo corporativo
                </p>
              </td>
            </tr>
          </table>
      ...
      <tr>
        <td align="center" style="padding:24px 16px;">
            ...
            <tr>
              <td style="padding:32px 32px 20px 32px; text-align:center;">
                ...
                <p style="margin:0 0 24px 0; font-size:15px; color:#334155; text-align:center;">
                  Confirme su correo para continuar con el proceso de aprobacion.
                </p>
                <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; margin:0 auto;">
                  <tr>
                    <td align="center" bgcolor="#0A7CC4" style="border-radius:8px;">
                      <a href="{{ $verificationUrl }}" style="display:inline-block; padding:12px 20px; color:#ffffff; text-decoration:none; font-weight:600; font-size:14px;">
                        Verificar correo
                      </a>
                    </td>
                  </tr>
          ...
          <p style="margin:16px 0 0 0; font-size:12px; color:#94a3b8;">
            (c) {{ date('Y') }} FUALTEC. Todos los derechos reservados.
          </p>
        </td>
      </tr>
    </table>
