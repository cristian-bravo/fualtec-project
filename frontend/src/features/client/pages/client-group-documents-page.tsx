...
import { downloadClientGroup } from "../services/clientService";
...
export const ClientGroupDocumentsPage = () => {
  ...
  const handleOpenViewer = async (doc: { id: number; title: string }) => {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:text-slate-900"
          >
